...
export default {
  ...
  methods: {
    ...
    createMesh(geo, mat) {
      for(let i=this.posStart; i<=this.posEnd; i+=this.posBetween) {
        for(let j=this.posStart; j<=this.posEnd; j+=this.posBetween) {
          for(let k=this.posStart; k<=this.posEnd; k+=this.posBetween) {
